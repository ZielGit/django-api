...
urlpatterns = [
    ...
    path('get-department/<str:dep_id>', views.get_department),
    path('update-department/<str:dep_id>', views.update_department),
    path('delete-department/<str:dep_id>', views.delete_department),
